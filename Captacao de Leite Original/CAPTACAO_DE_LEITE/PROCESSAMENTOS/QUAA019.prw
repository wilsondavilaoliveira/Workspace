...
±±³Program   ³ QUAA019  ³ Autor ³Darlan A. Freitas Maciel ³ Data ³ 05/01/2008 ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³Descri‡…o ³ Cadastro de Carreteiros.                                       ³±±
...
±±³Aplicacao ³                                                                ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³Uso       ³ Quata - PL8.10 - FS07529302 - Proposta 4                       ³±±
...
*/
User Function QUAA019

Private cAlias := "LBE"

dbSelectArea(cAlias)
dbSetOrder(1)
AxCadastro(cAlias,"Cadastro de Carreteiros","U_DelQuaa19()") 

//If cFilAnt $ GetMv("ES_SMARTQ") // Wilson 10/05/2018
//	If MsgYesNo(OemToAnsi("Deseja atualizar cadastros SmartQuestion?"))
//		MsgRun("Atualizando SmartQuestion, aguarde. . .","SMARTQUESTION",{|| U_WSVeiculo()})
//	End If
//End If
...
±±ºPrograma  ³DelQuaa19 º Autor ³ Choite             º Data ³  22/02/01   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDescricao ³VALIDACAO DA EXCLUSAO DO CADASTRO DE CAMINHOES              º±±
...
Aadd(aChave, {"LBC","LBC_CODCAM",LBE->LBE_CODCAM,NIL} )
