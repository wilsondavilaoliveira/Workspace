...
if nOpcA == 1 .AND. nOpcE == 4 // ok 
	If MsgYesNo("Deseja efetivar lançamento de leite?")
		MsgRun("Efetivando Lançamento de Leite no Protheus. . .","SMARTQUESTION",{|| GrvEnt()})
	End If
Endif
Return Nil
/*
...
Static Function GrvEnt()
	...
	If ZZS->ZZS_STATUS <> '1'
		MsgStop("Leitura ja lançada, nao e possivel novo lançamento!")
		Return .F.
	End If
