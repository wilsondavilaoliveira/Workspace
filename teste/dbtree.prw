...
Através do exemplo abaixo, é possível montar um tree com itens e sub-itens.

Vale lembrar que devem ser utilizados os includes 'protheus.ch' e 'dbtree.ch'

Para testar o programa abaixo, basta compilá-lo, e inserir uma chamada ao mesmo no Menu do ERP, no módulo desejado.

#include 'protheus.ch'
#include 'dbtree.ch'
User Function MyTree()// Cria um diálogo
DEFINE DIALOG oDlg TITLE "Teste de DBTree"
FROM 10,10 TO 400,700 COLOR CLR_BLACK,CLR_WHITE PIXEL// Cria o DbTree no diálogo, ocupando o tamanho total do mesmo
