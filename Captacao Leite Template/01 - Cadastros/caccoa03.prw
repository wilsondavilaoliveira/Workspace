...
±±ºPrograma  ³CACCOA03  º Autor ³ Choite             º Data ³  22/02/01   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDescricao ³CADASTRO DE CAMINHOES                                       º±±
...
AxCadastro(cAlias,"Cadastro de Caminhoes","u_DelCac03()")
